...
export default function SettingsPage() {
  ...
  async function loadSocialAccounts() {
    try {
      const r = await apiFetch("/api/social-accounts");
      const j = await r.json();
      setSocialAccounts(j);
    } catch (err) {
              ...
              <button
                ...
                onClick={async () => {
                  if (linkedinAccount) {
                    ...
                    try {
                      await apiFetch("/api/social-accounts/linkedin", {
                        method: "DELETE",
                      });
                      setSocialAccounts(
                    ...
                    try {
                      const r = await apiFetch("/api/auth/linkedin");
                      const j = await r.json();
              ...
              <button
                ...
                onClick={async () => {
                  if (facebookAccount) {
                    ...
                    try {
                      await apiFetch("/api/social-accounts/facebook", {
                        method: "DELETE",
                      });
                      setSocialAccounts(
                    ...
                    try {
                      const r = await apiFetch("/api/auth/facebook");
                      const j = await r.json();
                      window.location.href = j.url;
                    } catch (err) {
                      console.error(err);
